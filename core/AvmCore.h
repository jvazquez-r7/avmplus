...
const int kBufferPadding = 16;
    ...
    public:
        ...
        unsigned watson3548918:1;       // For appendChild, if the newChild is already in the tree, it is first removed.
		unsigned watson3573621:1;		// HTTPStatusEvent is not sent when the request has to have a crossdomain policy file checked.
    protected:
        friend class AvmCore;
    ...
    public:
        ...
        virtual uintptr_t getStackBase() const
        {
            return 0;
        }
        /**
        ...
        {
            (void) p;
            // NOTE: the shell currently does not implement setStackBase() or restoreStackBase().
        }
#ifdef _DEBUG
