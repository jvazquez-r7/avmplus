...
namespace avmplus
{
    ...
    AttributeE4XNode::AttributeE4XNode (E4XNode *parent, String *value) : E4XNode(parent), m_value(value)
    {
        ...
        if (memSampler)
        {
            memSampler->recordNewObjectAllocation(this, ".mem.xml.attribute", (size_t) bytesUsedShallow());
        }
#endif
    }
    ...
    CDATAE4XNode::CDATAE4XNode (E4XNode *parent, String *value) : E4XNode(parent), m_value(value)
    {
        ...
        if (memSampler)
        {
            memSampler->recordNewObjectAllocation(this, ".mem.xml.cdata", (size_t) bytesUsedShallow());
        }
#endif
    }
    ...
    CommentE4XNode::CommentE4XNode (E4XNode *parent, String *value) : E4XNode(parent), m_value(value)
    {
        ...
        if (memSampler)
        {
            memSampler->recordNewObjectAllocation(this, ".mem.xml.comment", (size_t) bytesUsedShallow());
        }
#endif
    }
    ...
    PIE4XNode::PIE4XNode (E4XNode *parent, String *value) : E4XNode(parent), m_value(value)
    {
        ...
        if (memSampler)
        {
            memSampler->recordNewObjectAllocation(this, ".mem.xml.processinginstruction", (size_t) bytesUsedShallow());
        }
#endif
    }
    ...
    TextE4XNode::TextE4XNode (E4XNode *parent, String *value) : E4XNode(parent), m_value(value)
    {
        ...
        if (memSampler)
        {
            memSampler->recordNewObjectAllocation(this, ".mem.xml.text", (size_t) bytesUsedShallow());
        }
#endif
    }
    ...
    ElementE4XNode::ElementE4XNode (E4XNode *parent) : E4XNode(parent)
    {
        ...
        if (memSampler)
        {
            memSampler->recordNewObjectAllocation(this, ".mem.xml.element", (size_t) bytesUsedShallow());
        }
#endif
    }
