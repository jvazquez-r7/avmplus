...
function hex_hmac_sha1(key:String, data){ return binb2hex(core_hmac_sha1(key, data));}
function b64_hmac_sha1(key:String, data){ return binb2b64(core_hmac_sha1(key, data));}
function str_hmac_sha1(key:String, data){ return binb2str(core_hmac_sha1(key, data));}
