...
final class middle2 extends middle1 {
    override function f() : Boolean {
        return  true; //return true because should come here
    }
}

//I think this only works because we propagate the traits of middle2
//through to the callsite and then observer that the class is final
function tester(){
...
trace("inline-finalclass: can inline middle2.f only because middle2 class is final and new dominates callsite. Is this a fluke?")
var s = tester()
