...
# standard performance run
    echo ""
    echo "===========   JSBench   ==========="
    python ./runtests.py --config=jsbench -r $branch -k -f -i 3 --vmargs="-Ojit"
    test "$?" = "0" || { 
        result="1"; 
    ...
    echo ""
    echo "===========   Misc   ==========="
    python ./runtests.py --config=misc-mobile-Ojit -r $branch -k -f -i 3 --vmargs="-Ojit"
    test "$?" = "0" || { 
        result="1"; 
    ...
    echo ""
    echo "===========   SunSpider   ==========="
    python ./runtests.py --config=sunspider-mobile-Ojit -r $branch -k -f -i 10 --vmargs="-Ojit"
    test "$?" = "0" || { 
        result="1"; 
    ...
    echo ""
    echo "===========   V8   ==========="
    python ./runtests.py --config=v8 -r $branch -k -f -i 3 --larger --vmargs="-Ojit"
    test "$?" = "0" || { 
        result="1"; 
