...
namespace MMgc
{
    ...
    public:
        ...
        */
         ...
         * offset remains a representable address.  If the test fails, we proceed as if
         * an attempt had been made to allocate an object larger than kMaxObjectSize.
         * While this may not be strictly correct, the only recourse the user will have
         * to avoid failure of this check is to reduce the size of an allocation.
         * See GC::allocaPush().
         */
