...
AddStrictTestCase("float4.isNotEqual((-0f), (0f))", new float4(0f), float4.isNotEqual(flt4_a, flt4_b));
AddStrictTestCase("float4.isNotEqual((0f), (-0f))", new float4(0f), float4.isNotEqual(flt4_b, flt4_a));
