...
shell_suffix="_64"
shell_extension=".exe"
base_configure_args="--target=x86_64-windows"
...
cd $WS/objdir/shell/
wget ${build_url}platform=windows64/artifact/objdir/shell/avmshell${shell_suffix}${shell_extension}
chmod 777 avmshell${shell_suffix}${shell_extension}
wget ${build_url}platform=windows64/artifact/objdir/shell/avmshell_s${shell_suffix}${shell_extension}
chmod 777 avmshell_s${shell_suffix}${shell_extension}
wget ${build_url}platform=windows64/artifact/objdir/shell/avmshell_d${shell_suffix}${shell_extension}
chmod 777 avmshell_d${shell_suffix}${shell_extension}
wget ${build_url}platform=windows64/artifact/objdir/shell/avmshell_sd${shell_suffix}${shell_extension}
...
#############################
# VerifyAll Release Debugger Acceptance
# This one is slightly different since it doesn't do the abcdump comparision, just runs with the -Dverifyall switch
#############################
export shell_name=avmshell_s
export AVM="$WS/objdir/shell/$shell_name$shell_suffix${shell_extension}"
...
cd $WS/objdir/shell/
wget ${build_url}platform=windows/artifact/objdir/shell/avmshell${shell_extension}
chmod 777 avmshell${shell_extension}

cd $WS/build/buildbot/slaves/scripts
../all/run-acceptance-avmdiff-3264.sh "$rev_id"
if [ "$?" != "0" ]; then
    echo "Differential acceptance failure."
    exitcode=1
fi
